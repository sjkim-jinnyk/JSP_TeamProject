			...
			<div class="frmInfo">
				<ul class="intList">
					<li>
						...
						<div class="intInner">
							<span class="intArea">
								<input type="text" value="${userId }" id="dsId" name="qna_id" aria-required="true" readonly="readonly">
							</span>
						</div>
					</li>
					<li>
						...
						<div class="intInner">
							<span class="intArea">
								<input type="text" id="dsTitle" name="qna_title" aria-required="true" placeholder="제목을 입력해주세요.">
							</span>
						</div>
					</li>
					<li>
...
사전 통보없이 삭제 처리될 수 있으며, 등록된 의견은 수정이 불가하오니 이 점 양지하여 주시기 바랍니다."></textarea>
							</span>
						</div>
